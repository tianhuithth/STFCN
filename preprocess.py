"""
preprocess for spatial-temporal representation data
...
def import_data(sub_index, datatype):
    data, label = [], []
    # path = '/home/Documents/MI/experiments/data/cv_data2/A0' 
    path = './collected_data/S'
    # path = '/home/Documents/MI/experiments/gen_data/tri_data_mat/processed/A0'
